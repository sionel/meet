    ...
    static void initReactInstanceManager(Application application) {
        ...
        reactInstanceManager
            = ReactInstanceManager.builder()
                ...
                .addPackage(new com.swmansion.gesturehandler.react.RNGestureHandlerPackage())
                .addPackage(new org.wonday.orientation.OrientationPackage())
                ...
                .addPackage(new com.reactnativecommunity.webview.RNCWebViewPackage() {
                    @Override
