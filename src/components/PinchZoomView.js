/**
 * git: https://github.com/GuoChen-WHU/react-native-pinch-zoom-view/blob/master/index.js
 * lisence: MIT
 * about: https://www.npmjs.com/package/react-native-pinch-zoom-view
 */
...
export default class PinchZoomView extends Component {
  ...
  _handlePanResponderMove = (e, gestureState) => {
    ...
    // translate
      ...
      if (this.state.scale > 1.02)
        this.setState({ offsetX, offsetY, lastMovePinch: false });
      else this.setState({ offsetX: 0, offsetY: 0, lastMovePinch: false });
    }
  };
