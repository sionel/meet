        ...
        view: (
          ...
          >
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={{ marginTop: 107.5, color: '#FFF', fontSize: 17, fontFamily: 'NanumSquareEB', }}>언제 어디서나 WEHAGO Meet</Text>
            <Text style={{ marginTop: 24.5, color: 'rgb(193, 219, 246)', fontSize: 12, fontFamily: 'NanumSquareB' }}>시간과 장소의 제약 없는 효율적인 화상회의</Text>
          </View>
        )
      },
      {
