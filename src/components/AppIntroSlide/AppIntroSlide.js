...
class AppIntroSlide extends React.Component {
	slides = [
		{
			...
			view: (
				...
				>
					<Image source={introImages[0]} style={{ width: 144, height: 144 }} resizeMode="contain" />
					<Text
						style={{ marginTop: 70.5, color: '#FFF', fontSize: 25, fontWeight: '700', textAlign: 'center' }}
					>
						{'언제 어디서나\nWEHAGO Meet'}
					</Text>
					<Text style={{ marginTop: 24.5, color: 'rgb(193, 219, 246)', fontSize: 16 }}>
		...
		},
		{
			...
			view: (
				...
				>
					...
					<Image source={introImages[1]} style={{ width: '100%', flex: 2 }} resizeMode="contain" />
				</View>
			)
		},
		{
			...
			view: (
				...
				>
					...
					<Image source={introImages[2]} style={{ width: '100%', flex: 2 }} resizeMode="contain" />
				</View>
			)
		},
		{
			...
			view: (
				...
				>
					...
					<Image source={introImages[3]} style={{ width: '100%', flex: 2 }} resizeMode="contain" />
				</View>
			)
		},
		{
			...
			view: (
				...
				>
					...
					<Image source={introImages[4]} style={{ width: '100%', flex: 2 }} resizeMode="contain" />
				</View>
			)
		}
	];
	...
	_renderItem = (item, index) => {
		return <View style={{ flex: 1, width: item.width, height: item.height }}>{item.view}</View>;
	};
