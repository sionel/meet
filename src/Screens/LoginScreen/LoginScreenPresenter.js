    ...
    >
      ...
      <View style={styles.bottomArea2}>
        ...
        >
          ...
          />
          <Text style={{ color: '#fff', fontFamily: 'NanumSquareB' }}>WEHAGO 앱으로 로그인</Text>
        </FlatButton>
        <Text
          style={{
            paddingTop: 12,
        ...
        <View style={styles.permission_modalWrap}>
          <View style={styles.permission_modalContentWrap}>
            <View style={styles.permission_modalMessage}>
              ...
              >
                <Text
                  style={{ fontSize: 15, color: '#1C90FB', fontFamily: 'NanumSquareEB' }}
                >
                  필수적 접근권한
                </Text>
                <View
                  ...
                  <FlatList
                    ...
                    renderItem={({ item }) => (
                      ...
                      >
                        ...
                        >
                          <Text style={{ fontSize: 15, marginBottom: 3.5, fontFamily: 'NanumSquareB' }}>
                            {item.title}
                          </Text>
                          <Text
                            style={{ fontSize: 12, color: 'rgb(114,125,134)', fontFamily: 'NanumSquareB' }}
                          >
                            {item.description}
                          </Text>
                        </View>
